...
class list_member extends CI_Model {
...
public function get_members(){
        ...
        public function insert($upload)
        {
            $data = array(
                ...
                'no_hp' => $this->input->post('input_nomor'),
    ...
    public function update($post, $id){
        ...
        $alamat_atk = $this->db->escape($post['alamat_atk']);
        $nomor_atk = $this->db->escape($post['nomor_atk']);
        ...
        $sql = $this->db->query("UPDATE users SET fk_level_id = $level_atk, nama = $nama_atk, alamat = $alamat_atk, nomor = $nomor_atk, kodepos = $kodepos_atk, email = $email_atk, username = $username_atk, password = $password_atk WHERE user_id = ".intval($id));
        return true;
    }
