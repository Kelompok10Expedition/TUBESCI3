    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 offset-lg-2">
          ...
          <?php echo form_open('view_member/tambah', array('class' => 'needs-validation', 'novalidate' => '')); ?>
          ...
          <label>Nomor HP</label>
            ...
            <input type="number" class="form-control" name="nomor" placeholder="Nomor Handphone">
